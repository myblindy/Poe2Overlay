...
static class ImageListener
{
    ...
    static readonly L8[][] chargecount3Masks = [
        ...
        [new(0),new(9),new(47),new(47),new(9),new(0),new(0),new(108),new(194),new(193),new(109),new(0),new(0),new(52),new(38),new(124),new(147),new(0),new(0),new(0),new(47),new(224),new(112),new(0),new(0),new(0),new(15),new(156),new(206),new(31),new(0),new(0),new(0),new(84),new(224),new(42),],
    ];
    static readonly L8[][] chargeCount4Masks = [
        ...
        [new(0),new(0),new(0),new(2),new(36),new(26),new(0),new(0),new(0),new(50),new(213),new(135),new(0),new(0),new(14),new(161),new(254),new(150),new(0),new(0),new(94),new(154),new(212),new(150),new(0),new(22),new(196),new(153),new(220),new(195),new(0),new(32),new(147),new(159),new(234),new(215),],
    ];
    ...
    static readonly L8[][] chargeCount6Masks = [
        [new(0), new(0), new(62), new(199), new(195), new(98), new(0), new(27), new(196), new(117), new(27), new(46), new(0), new(54), new(232), new(142), new(117), new(12), new(0), new(56), new(191), new(78), new(199), new(127), new(0), new(56), new(196), new(23), new(117), new(158), new(0), new(48), new(228), new(70), new(136), new(145),],
        [new(0),new(51),new(194),new(199),new(98),new(0),new(22),new(185),new(132),new(26),new(43),new(1),new(47),new(227),new(147),new(124),new(16),new(0),new(49),new(193),new(78),new(192),new(127),new(0),new(49),new(198),new(32),new(101),new(154),new(0),new(41),new(222),new(84),new(122),new(142),new(0),],
    ];
    #endregion
